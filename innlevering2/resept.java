abstract class Resept {
    ...
    protected Resept (Legemiddel legemiddel, Lege utskriveLege, int pasient, int rei) {            //Setter til protected slik at den ikke kan aksesseres fra utsiden av klassen eller subklassene
    ...
    public int hentPasientId () {           //Returnerer pasient ID
        return pasientId;
